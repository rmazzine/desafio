...
for item in items:
    ...
    for dia in lista_dias:
        ...
        lista_output.append(int(entrada_quant))
        """Adicionar lanc_Ent_valor"""
        lista_output.append(int(entrada_valor))
        """Adicionar lanc_Sai_qtd"""
        lista_output.append(int(saida_quant))
        """Adicionar lanc_Sai_valor"""
        lista_output.append(int(saida_valor))
        """Adicionar saldo_inicio_valor"""
        lista_output.append(int(saldo_inicio_valor))
        """Adicionar saldo_inicio_qtd"""
        lista_output.append(int(saldo_inicio_quant))
        """Adicionar saldo_final_valor"""
        lista_output.append(int(saldo_final_valor))
        """Adicionar saldo_final_qtd"""
        lista_output.append(int(saldo_final_quant))
